...
public class ShaderProgram {
	...
	public void initializeShaderParam() {
		aPosition = GLES20.glGetAttribLocation(programHandler, "aPosition");// получаем указатель для переменной программы aPosition		
		aTextureCoord = GLES20.glGetAttribLocation(programHandler, "aTextureCoord");				
		uBaseMap = GLES20.glGetUniformLocation(programHandler, "uBaseMap");
	}
